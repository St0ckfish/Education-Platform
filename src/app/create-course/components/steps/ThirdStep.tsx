...
const ThirdStep: React.FC<ThirdStepProps> = ({ dataAddCourse, handleNext, handlePrev }) => {
    ...
    const handleSend = async () => {
        const reqObject = {
            "courseId": dataAddCourse?.data?.id,
    ...
    const addNewTopic = () => {
        setAllTopics([...allTopics, { name_en: "", name_ar: "", name_fr: "", videoUrls: [""] }]);
    ...
    const updateVideo = (topicIndex: number, videoIndex: number, value: string) => {
        const updatedTopics = [...allTopics];
    ...
    const deleteTopic = (index: any) => {
        setTutorials(prevTutorials => prevTutorials.filter((_, i) => i !== index));
    ...
    return (
        <div className='bg-white card p-3 shadow-md  rounded-md'>
            <div>
                ...
                <div className='my-3'>
                    <div className="mb-4 block">
                        <Label className='md:text-lg capitalize font-medium' htmlFor="LessonNameEn" value="Lesson Name English" />
                    </div>
                    <TextInput value={lessonNameEn} onChange={(e) => setLessonNameEn(e.target.value)} id="LessonNameEn" type="text" placeholder="Enter lesson name" required />
                </div>
                <div className='my-3'>
                    <div className="mb-4 block">
                        <Label className='md:text-lg capitalize font-medium' htmlFor="LessonNameAr" value="Lesson Name Arabic" />
                    </div>
                    <TextInput value={lessonNameAr} onChange={(e) => setLessonNameAr(e.target.value)} id="LessonNameAr" type="text" placeholder="Enter lesson name" required />
                </div>
                <div className='my-3'>
                    <div className="mb-4 block">
                        <Label className='md:text-lg capitalize font-medium' htmlFor="LessonNameFr" value="Lesson Name French" />
                    </div>
                    <TextInput value={lessonNameFr} onChange={(e) => setLessonNameFr(e.target.value)} id="LessonNameFr" type="text" placeholder="Enter lesson name" required />
                </div>
                <div className='my-3'>
                    <div className="mb-4 block">
                        <Label className='md:text-lg capitalize font-medium' htmlFor="LessonGoalsEn" value="Lesson Goals English" />
                    </div>
                    <TextInput value={lessonGoalsEn} onChange={(e) => setLessonGoalsEn(e.target.value)} id="LessonGoalsEn" type="text" placeholder="Enter lesson goals" required />
                </div>
                <div className='my-3'>
                    <div className="mb-4 block">
                        <Label className='md:text-lg capitalize font-medium' htmlFor="LessonGoalsAr" value="Lesson Goals Arabic" />
                    </div>
                    <TextInput value={lessonGoalsAr} onChange={(e) => setLessonGoalsAr(e.target.value)} id="LessonGoalsAr" type="text" placeholder="Enter lesson goals" required />
                </div>
                <div className='my-3'>
                    <div className="mb-4 block">
                        <Label className='md:text-lg capitalize font-medium' htmlFor="LessonGoalsFr" value="Lesson Goals French" />
                    </div>
                    <TextInput value={lessonGoalsFr} onChange={(e) => setLessonGoalsFr(e.target.value)} id="LessonGoalsFr" type="text" placeholder="Enter lesson goals" required />
                </div>
                            ...
                            <div className="collapse-content">
                                <div className='my-3'>
                                    ...
                                    <TextInput
                                        ...
                                        value={topic.name_en}
                                        onChange={(e) => updateTopic(index, 'name_en', e.target.value)}
                                        required
                                    />
                                </div>
                                <div className='my-3'>
                                    ...
                                    <TextInput
                                        ...
                                        placeholder="Enter topic name"
                                        value={topic.name_ar}
                                        onChange={(e) => updateTopic(index, 'name_ar', e.target.value)}
                                        required
                                    />
                                </div>
                                <div className='my-3'>
                                    ...
                                    <TextInput
                                        ...
                                        placeholder="Enter topic name"
                                        value={topic.name_fr}
                                        onChange={(e) => updateTopic(index, 'name_fr', e.target.value)}
                                        required
                                    />
                                </div>
                                <div className='my-3'>
            ...
            <div className='my-4 flex justify-end'>
                ...
                <button onClick={handleSend} className='text-white font-medium border border-[#367AFF] flex items-center bg-[#367AFF] md:text-lg py-1.5 px-8 rounded-lg hover:opacity-80' >Next
