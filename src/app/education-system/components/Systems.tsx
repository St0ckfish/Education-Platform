...
import { useDeleteEduSystemMutation } from '../api/manageSystems';
...
const Systems: React.FC<Props> = ({ data, search, setSearch, isLoading, setCurrentPage }) => {
    ...
    const handleDelete = () => {
        if (selectedEduId !== null) {
            deleteEduSystem({ token, id: selectedEduId })
                                ...
                                <tbody>
                                    {data?.data?.content.map((item: any, index: number) => (
                                        <tr key={index} className="bg-white card border-b  hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <Link href={`/education-system/${item.id}`} className='me-4 inline-block'>
                ...
                <Modal.Body>
                    <div className="text-center">
                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                            Are you sure you want to delete this education system?
                        </h3>
