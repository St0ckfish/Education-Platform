...
const AddTopic: React.FC<AddTopicProps> = ({
  ...
  const deleteVideo = (videoIndex: number) => {
    const updatedVideos = topic.videoUrls.filter(
  ...
  return (
    <Modal show onClose={onClose} className="z-[10000]">
      ...
      <Modal.Body>
        ...
        <div className="my-3">
          <Label
            ...
            value="Upload File"
          />
          <FileInput onChange={handleFileChange} accept="*/*" />
        </div>
