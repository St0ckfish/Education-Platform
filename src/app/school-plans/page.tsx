...
import { useGetAllSchoolPlansQuery, useUpdateStatusOfSchoolPlanMutation } from './api/SchoolPlans';
                                    ...
                                    <tr key={item.id} className="bg-white border-b  hover:bg-gray-50 card">
                                        ...
                                        <td className="px-6 py-4 flex justify-center whitespace-nowrap">
                                            <ToggleSwitch
                                                className="me-2"
                                                checked={item.active}
                                                onChange={() => handleUpdateStatus({ schoolPlanId: item.id, status: item.active })}
                                            />
